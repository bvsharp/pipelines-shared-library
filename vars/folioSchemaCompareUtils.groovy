...
//        slackNotifications.sendSchemaComparisonSlackNotification("massage","#folioschemacompare", currentBuild.result)
//    } catch (Exception e) {
  ...
  try {
    ...
    if (message) {
      ...
      if (slackNotifications) {
        ...
        slackNotifications.sendSchemaComparisonSlackNotification(messege:message, "#folioschemacompare", currentBuild.result)
      } else {
